...
export class DialogBox extends Phaser.GameObjects.Container {
  ...
  constructor(public scene: Phaser.Scene, {
    x, y, width, height, padding = 10, margin = 10, textStyle = {},
  }: DialogBoxConfig) {
    ...
    const dialogBoxTextStyle = {
      ...
      useAdvancedWrap: true, // useAdvanceWrap で日本語の折り返し対応
    };
  ...
  public setActorNameText(name: string) {
    ...
    // ts-ignore は型チェックを無視する,基本非推奨 https://scrapbox.io/terrierscript/%E4%BB%8A%E3%81%93%E3%81%9D%E4%BC%9D%E3%81%88%E3%81%9F%E3%81%84%EF%BC%81@ts-ignore%E3%81%AE%E9%AD%85%E5%8A%9B
    // @ts-ignore
