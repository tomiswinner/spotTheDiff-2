...
export class StopButton extends Phaser.GameObjects.Zone {
  ...
  constructor(scene: GameScene, x: number, y: number, width: number, height: number, private gameManager: GameManager,private menuScreen: Phaser.GameObjects.Container) {
